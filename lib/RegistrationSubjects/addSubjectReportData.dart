...
class AddSubjectReportData extends StatefulWidget {
  ...
  AddSubjectReportData({required this.databaseReference, required this.id, required this.subject_name,required this.classes,required this.reports,required this.index});

  @override
  State<StatefulWidget> createState() {
    return _AddSubjectReportData();
  }
}

class _AddSubjectReportData extends State<AddSubjectReportData> {
  DateTime? selectDate;
